...
class StatusController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('statuses.index', ['statuses' => $statuses])->with('statuses', $statuses);
    }
    ...
    public function store(StoreStatusPost $request)
    {
        ...
        return view('statuses.index')->with('success', __('messages.create'));
    }
    ...
    {
        return view('customers.index')->with('statuses', Customer::findOrFail($id));
    }
